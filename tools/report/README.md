...
it every page gets a URL and a date in the margins. Verified on 2026-09-19: this chain
reproduces the committed `docs/sample-report.pdf` byte for byte, 33 pages.
